        ...
        class AgreeCommand < Aethyr::Extend::EmoteAction
          ...
          def action
            ...
            make_emote self, player, room do
              ...
              target do
                to_player "You nod your head in agreement with #{self.target.name}."
                to_target "#{player.name} nods #{player.pronoun(:possessive)} head in agreement with you."
                to_other "#{player.name} nods #{player.pronoun(:possessive)} head in agreement with #{self.target.name}."
                to_deaf_other self[:to_other]
              end
            end
