        ...
        class CurtseyCommand < Aethyr::Extend::EmoteAction
          ...
          def action
            ...
            make_emote self, player, room do
              ...
              target do
                to_player "You curtsey gracefully and respectfully towards #{self.target.name}."
                to_target "#{player.name} curtseys gracefully and respectfully in your direction."
                to_other "#{player.name} curtseys gracefully and respectfully towards #{self.target.name}."
                to_deaf_other self[:to_other]
              end
