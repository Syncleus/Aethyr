          ...
          def action
            ...
            make_emote self, player, room do
              ...
              self_target do
                ...
                to_other "#{player.name} blushes at #{self.target.pronoun(:possessive)} foolishness."
                to_deaf_other self[:to_other]
              end

              target do
                to_player "Your face turns red and you blush at #{self.target.name} uncomfortably."
                to_target "#{player.name} blushes in your direction."
                to_deaf_target self[:to_target]
                to_other "#{player.name} blushes at #{self.target.name}, clearly uncomfortable."
                to_deaf_other self[:to_other]
              end
            end
          end
