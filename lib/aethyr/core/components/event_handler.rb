...
require 'aethyr/extensions/skills'

#The Manager passes commands through a queue to the EventHandler, which then executes the commands according to the type and action of the Event.
#This is done by matching the type to a module defined in the commands/ directory and calling the method with the name of the action.
class EventHandler
